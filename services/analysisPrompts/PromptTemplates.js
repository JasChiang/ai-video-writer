...
1. **僅使用 Markdown 表格**展示所有資料（包含健康度評分）
2. **嚴格禁止使用圖表**：
   - ❌ **禁止使用任何 Mermaid 圖表**（容易產生語法錯誤）
   - ❌ **禁止使用雷達圖、餅圖、四象限圖等**
   - ✅ **只使用 Markdown 表格和文字說明**（清晰、可靠、不會出錯）
3. **每個建議必須包含**：
   - 具體執行步驟
   - 預期成效（量化）
   - 執行難度（低/中/高）
...
1. **僅使用 Markdown 表格**展示所有資料
2. **嚴格禁止使用圖表**：
   - ❌ **禁止使用任何 Mermaid 圖表**（容易產生語法錯誤）
   - ✅ **只使用 Markdown 表格和文字說明**
3. 每個策略必須包含執行步驟和預期成效
...
1. **僅使用 Markdown 表格**展示觀眾分布資料（年齡、性別、地理、設備）
2. **嚴格禁止使用圖表**：
   - ❌ **禁止使用任何 Mermaid 圖表**（容易產生語法錯誤）
   - ✅ **只使用 Markdown 表格和文字說明**（清晰易讀、不會出錯）
3. 提供 3-5 個具體的內容定位建議
