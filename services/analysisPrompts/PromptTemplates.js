...
2. **圖表使用規則（可選）**：
   - ✅ **可使用 Chart.js 圖表**（餅圖或長條圖，本地渲染、100% 可靠）
   - ❌ **禁止使用 Mermaid 圖表**（容易語法錯誤）
   - ⚠️ **圖表語法範例**：
     ```
     <!-- CHART:PIE
     {
...
1. **圖表使用規則（可選）**：
   - ✅ **可使用 Chart.js 餅圖**展示觀眾分布（例如年齡、性別、地理位置）
     ```
     <!-- CHART:PIE
     {
       "title": "觀眾年齡分布",
